...
complete -c kastell -n '__kastell_no_subcommand' -a 'auth' -d 'Manage provider API tokens'
...
complete -c kastell -n '__kastell_no_subcommand' -a 'bot' -d 'Telegram bot management'
complete -c kastell -n '__kastell_no_subcommand' -a 'changelog' -d 'Show version changelog'
...
complete -c kastell -n '__kastell_no_subcommand' -a 'install' -d 'Install a plugin from npm registry'
...
complete -c kastell -n '__kastell_no_subcommand' -a 'start' -d 'Start guard daemon on a server'
complete -c kastell -n '__kastell_no_subcommand' -a 'status' -d 'Check server and Coolify status'
complete -c kastell -n '__kastell_no_subcommand' -a 'stop' -d 'Stop guard daemon on a server'
complete -c kastell -n '__kastell_no_subcommand' -a 'update' -d 'Update Coolify on a server'
complete -c kastell -n '__kastell_no_subcommand' -a 'validate' -d 'Validate plugin manifest'
